package com.sweetpoint.demo.constant;

public class ConstantApp {
    public static final String KEY_FOUND ="Berhasil!";
    public static final String ERROR ="Terjadi sebuah error!";
    public static final String KEY_NOT_FOUND  = "Data tidak ditemukan!";
